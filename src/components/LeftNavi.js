...
function LeftNvi() {
  ...
  return (
    <LeftNaviWraper>
      <Wraper>
        <HomeMenu click={clickElement} onClick={() => clickHere()}>Home</HomeMenu>

        <MainMenu>
          <PublicMenu>PUBLIC</PublicMenu>
          <QuestionsContents click={clickElement} onClick={() => clickHere()}>
            <EarthIcon><IoEarthSharp /></EarthIcon>
            <QuestionsMenu>Questions</QuestionsMenu>
          </QuestionsContents>
          <Menu click={clickElement} onClick={() => clickHere()}>Tags</Menu>
          <Menu click={clickElement} onClick={() => clickHere()}>Users</Menu>
          <Menu click={clickElement} onClick={() => clickHere()}>Companies</Menu>
          <Collectives>COLLECTIVES</Collectives>
          <CollectivesContents click={clickElement} onClick={() => clickHere()}>
            <StarIcon><IoStarOutline /></StarIcon>
        ...
        <TeamMainMenu>
          <div>
            ...
            <CreateBtn click={clickElement} onClick={() => clickHere()}>Create a free Team</CreateBtn>
